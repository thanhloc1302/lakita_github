        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <section class="group4">
                    ...
                    <div class="row gr4-row-2" data-step="1" data-intro="Tiếp theo bạn nhập <b>Mã kích hoạt</b> khóa học được cung cấp bởi Lakita.vn">
                    ...
                    <div class="row gr4-row-1" style="margin-top: 10px;" data-step="2" data-intro="<b>Mã giới thiệu</b> (nếu bạn được người khác giới thiệu mua khóa học trên Lakita.vn, nếu không có thì bỏ qua)">
