...
<html>
    <head>
        ...
        <meta property="og:image" content="https://lakita.vn/public/tet/img/tet.png" />
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>public/tet/style.css">
    </style>
</head>
<body>
    <div id="fb-root"></div>
    ...
    <div class="row top">
        <div style="margin-top: 20px">
            <div class="col-md-2 col-xs-2 col-sm-2 col-xs-2 col-sm-2 col-lg-2">
                <img src="<?php echo base_url() ?>public/tet/img/logo.png" width="100%" height="100%" style="margin-left: 20px">
            </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 col-sm-12">
            <div class="col-md-4 col-xs-4 col-sm-4">
                <img src="<?php echo base_url() ?>public/tet/img/lefttree.png" width="100%" height="100%">
            </div>
            <div class="col-md-4 col-xs-4 col-sm-4">
                <img src="<?php echo base_url() ?>public/tet/img/text-top.png" width="100%" height="100%">
            </div>
            <div class="col-md-4 col-xs-4 col-sm-4">
                <img src="<?php echo base_url() ?>public/tet/img/righttree.png" width="100%" height="100%">
            </div>
        </div>

        <div class="col-md-12 col-xs-12 col-sm-12 bot-header">
            <div class="col-md-3 col-xs-3 col-sm-3 text-top">
                <img src="<?php echo base_url() ?>public/tet/img/chukhuyenmai.png" width="120%" height="150%">
            </div>
            <div class="col-md-4 col-xs-12 col-sm-12 col-md-offset-1 form-top">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <input class="form-control" placeholder="Lĩnh Vực Kinh Tế Mà Bạn Quan Tâm">
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-danger" style="color: #f4e46d">Đăng Kí</button>
                    </div>
                </form>
            </div>
    ...
    <div class="row content-1">
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="col-md-3 col-xs-3 col-sm-3 img2">
                <img src="<?php echo base_url() ?>public/tet/img/tree2.png" width="100%" height="100%">
            </div>
    ...
    <div class="row content-2">
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="col-md-12 col-xs-12 col-sm-12 text3">
                <br><br>
                <img src="<?php echo base_url() ?>public/tet/img/xu.png" style="margin-left: 50px" height="50px">
        ...
        <div class="col-md-12 col-xs-12 col-sm-12 a">
            <div class="col-md-3 col-sm-6 col-md-offset-2 ">
                ...
                <div>
                    <button type="submit" class="btn btn-danger col-md-6 col-sm-6  col-xs-6 col-md-offset-3 col-ms-offset-3 col-xs-offset-3" style="color: #f4e46d; margin-bottom: 10px; margin-top: 2%">Đăng Kí Ngay</button></div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-md-offset-2">
                ...
                <button type="submit" class="btn btn-danger col-md-6 col-sm-6  col-xs-6 col-md-offset-3 col-ms-offset-3 col-xs-offset-3" style="color: #f4e46d; margin-bottom: 10px; margin-top: 2%">Đăng Kí Ngay</button>
            </div>
    ...
    <div class="row content-3">
        <div class="col-md-12 col-xs-12 col-sm-12">
            <img src="<?php echo base_url() ?>public/tet/img/boder-top-ct3.png" height="100%" width="100%">
        </div>
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="col-md-12 col-xs-12 col-sm-12">
                <br><br>
                <img src="<?php echo base_url() ?>public/tet/img/xu2.png" style="margin-left: 50px" height="50px">
        ...
        <div class="col-md-12 col-xs-12 col-sm-12 ">
            <div class="col-md-3 col-sm-4 col-md-offset-1 text6">
                <a href="#"><img src="<?php echo base_url() ?>public/tet/img/qt.png" width="100%" height="100%"></a>
                <p> Tiến Sĩ</p>
                <span style="font-weight: bold;"> HOÀNG QUANG TRUNG</span>

            </div>
            <div class="col-md-3 col-sm-4 col-md-offset-1 text6">
                <a href="#"><img src="<?php echo base_url() ?>public/tet/img/tho.png" width="100%" height="100%"></a>
                <p>Kế toán trưởng</p>
                <span style="font-weight: bold;">ĐÀO THỊ THƠ</span>

            </div>
            <div class="col-md-3 col-sm-4 col-md-offset-1 text6">
                <a href="#"><img src="<?php echo base_url() ?>public/tet/img/nhu.png" width="100%" height="100%"></a>
                <p>Giảng viên</p>
        ...
        <div>
            <div class="col-md-3 col-sm-4 col-md-offset-1 text6">
                <br><br>
                <img src="<?php echo base_url() ?>public/tet/img/xu2.png" height="50px">
                <span class="text5">Lĩnh vực Excel</span>
                <br><br>		
                <a href="#"><img src="<?php echo base_url() ?>public/tet/img/tuu.png" width="100%" height="100%"></a>
                <p>Thạc Sĩ</p>
            ...
            <div class="col-md-3 col-sm-4 col-md-offset-1 text6">
                ...
                <br><br>		
                <a href="#"><img src="<?php echo base_url() ?>public/tet/img/trang.png" width="100%" height="100%"></a>
            ...
            <div class="col-md-3 col-sm-4 col-md-offset-1 text6">
                ...
                <br><br>		
                <a href="#"><img src="<?php echo base_url() ?>public/tet/img/hung.png" width="100%" height="100%"></a>
                <p>Thầy</p>
            ...
            <div class="col-md-5 col-sm-10 col-xs-10 col-md-offset-1 col-sm-offset-1 col-xs-offset-1">
                <div style="width: 100%; margin:5%;color: white;text-align: center;">
                        ...
                        <div>
                            <div class="row">
                                <div class="col-xs-3" style="padding: 0;">
                                    <div style="width: 60px; height: 60px; border-radius: 50%; background: #f43737; color: white; font-size: 40px; margin: auto; text-align: center; line-height: 50px;">
                                        00
                                    </div>
                    ...
                    <form action="" method="" accept-charset="utf-8">
                        ...
                        <div class="col-md-12 form-group form-group-lg">
                            <select class="form-control">
                                <option value="#" selected="true">Khóa học bạn quan tâm</option>
                                <option value="Combo1">Combo 1</option>
                                <option value="Combo2">Combo 2</option>
                                <option value="Combo3">Combo 3</option>
                                <option value="Combo4">Combo 4</option>
                        ...
                        <div class="col-md-12">
                            <button type="button" class="btn btn-danger btn-block">Đăng kí ngay</button>
                        </div>
    ...
    <div class="row footer">
        <div class="col-md-4 col-md-offset-2">
            <img src="<?php echo base_url() ?>public/tet/img/lg2.png" width="60%" height="60%" style="margin-top: 15%;">
            <br><h5>Nhập Email để nhận được thông báo khi có khuyến mãi</h5>

            <div class="col-md-10 input-group">
                <input type="text" class="form-control" placeholder="Your Email">
                <span class="input-group-btn">
                    <button class="btn btn-default" type="button" style="background: #1d7545; font-weight: bold; color: white">SUBSCRIBE</button>
                </span>
            </div>
        </div>

        <div class="col-md-5 col-md-offset-1">
            <h2 style="margin-top: 10%; font-weight: bold;">LIÊN HỆ</h2>
            <img src="<?php echo base_url() ?>public/tet/img/contact.png" width="65%" height="65%" style="margin-left: 60px">
        </div>
    </div>
