...
<head lang="en">
    <meta charset="UTF-8">
    <title class="title-site" lp-id="5a5f5b85b0f0b9867f55b1ab">Đặt tiêu đề trang</title>
    ...
    <meta property="og:url" content="http://demo.ladipage.me/5a5f5b85b0f0b9867f55b1ab" />
    ...
    <style id="lp-css-ladi">
        @media(min-width:768px) {
            ...
            #GROUP380 {
                top: 224.06251525878906px;
                left: -29px;
                width: 988.9791870117188px;
                height: 444.0208435058594px;
            }
            #FORM345 {
                top: 104.9375px;
                left: 168px;
    ...
    <link rel="stylesheet" href="https://static.ladipage.net/source/animate.min.css?v=516446220185" media="none" onload="if(media!='all')media='all'">
</head>
    ...
    <div class="ladi-wraper-page">
        ...
        <div id="SECTION9" class="widget-section ladi-drop" lp-type="widget_section" lp-widget="widget" lp-lang="SECTION" lp-display="block">
            <div class="container">
                ...
                <div id="BOX252" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-display="block">
                    <div class="widget-content"></div>
                    <div class="ladi-widget-overlay"></div>
                </div>
        ...
        <div id="SECTION308" class="widget-section ladi-drop" lp-type="widget_section" lp-widget="widget" lp-lang="SECTION" lp-display="block">
            <div class="container">
                ...
                <div id="HEADLINE344" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-display="block">
                    <h3 class="widget-content" lp-node="h3">MIỄN PHÍ SHIP TOÀN QUỐC</h3> </div>
                ...
                <div id="GROUP380" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                    <div class="widget-content">
                        ...
                        </div><a id="BUTTON350" class="widget-element widget-snap style-1 ladi-drop" lp-type="button" lp-lang="BUTTON" lp-background="button" lp-parent="FORM345" lp-group="GROUP380" lp-display="table"><span class="widget-content">ĐĂNG KÍ NGAY</span> </a>
                        <div id="BOX309" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP380" lp-display="block">
                            <div class="widget-content">
                                <div id="HEADLINE310" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-display="block">
                                    <h4 class="widget-content" lp-node="h4">Chương trình khuyến mãi áp dụng đến hết ngày .../..../....</h4> </div>
                ...
                <div id="COUNTDOWN419" class="widget-element widget-snap" lp-type="countdown" lp-lang="COUNTDOWN" lp-endtime="Thu Jan 14 2016 00:00:00 GMT+0700 (SE Asia Standard Time)" lp-display="block">
                    <div class="widget-content">
        ...
        <script type="text/javascript" async="" defer="" src="https://static.ladipage.net/source/ladipage.lib.1.js?v=1516446220186"></script>
    </div>
</body>
