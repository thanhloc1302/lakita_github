...
<html lang="en">
    <head>
        ...
        <title>Nghiệp Vụ Kế Toán Trong Doanh Nghiệp Kinh Doanh Dịch Vụ</title>
        <link rel="icon" href="https://lakita.vn/data/source/setting/favicon.png" />
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
        <script src="<?php echo base_url(); ?>public/kt320/js/responsive.js" type="text/javascript"></script>
        <script src="https://use.fontawesome.com/d826c84253.js"></script>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/kt320/css/bootstrap-theme.css">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/kt320/css/style.css">
    ...
    <body>
        ...
        <div class="container-fluid header">
            <nav class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><img id="logo" class="img-responsive col-sm-offset-1" src="<?php echo base_url(); ?>public/kt320/img/top-logo.png" alt="Lakita.vn"></a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <img class="img-responsive col-sm-offset-1 img-hide" src="<?php echo base_url(); ?>public/kt320/img/top-add.png" alt="">
                    ...
                    <div class="col-sm-6 col-md-5 col-md-offset-1">
                        <img class="img-responsive" src="<?php echo base_url(); ?>public/kt320/img/TYPO-04.png" alt="16 giờ học">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-7 saleoff">
                                <p><span><img src="<?php echo base_url(); ?>public/kt320/img/gift.png" alt=""></span> Khuyến mại giảm giá khóa học đến 400.000đ</p>
                            </div>
                        </div>
        ...
        <div class="container welcome fontSF">
            <div class="row wellcome-text">
                Chào mừng bạn đến với trang thông tin của khóa học Nghiệp Vụ Kế Toán Trong Doanh Nghiệp Kinh Doanh Dịch Vụ. Trước khi tìm hiểu chi tiết, Lakita xin tặng bạn<br>
                BỘ QUÀ TẶNG trị giá 5 trăm ngàn đồng sau:
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <img src="<?php echo base_url(); ?>public/kt320/img/18excel.jpg" alt="" class="img-responsive shadow">
                </div>
                <div class="col-sm-8">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 text-center feature">
                        <img src="<?php echo base_url(); ?>public/kt320/img/online.png" alt="Học online">
                        <p>HỌC ONLINE</p>
                        <p>Mô hình học online tiên tiến, mọi lúc, mọi nơi, mọi thiết bị</p>
                    </div>
                    <div class="col-sm-6 col-md-3 text-center feature">
                        <img src="<?php echo base_url(); ?>public/kt320/img/quality.png" alt="Cam kết chất lượng">
                        <p>CAM KẾT CHẤT LƯỢNG</p>
                        <p>Hoàn lại 100% tiền nếu bạn không hài lòng về khóa học</p>
                    </div>
                    <div class="col-sm-6 col-md-3 text-center feature">
                        <img src="<?php echo base_url(); ?>public/kt320/img/exchange.png" alt="Giải pháp nhanh chóng">
                        <p>GIẢI PHÁP NHANH CHÓNG</p>
                        <p>Đội ngũ trợ giảng giải đáp thắc mắc qua hệ thống forum tiện dụng</p>
                    </div>
                    <div class="col-sm-6 col-md-3 text-center feature">
                        <img src="<?php echo base_url(); ?>public/kt320/img/time.png" alt="Sở hữu trọn đời">
                        <p>SỞ HỮU TRỌN ĐỜI</p>
        ...
        <div class="container lineout">
            <div class="row">
                <div class="col-xs-12 text-center SFDisplay" style="font-size: 25px; color: #2e3d49;">DƯỚI ĐÂY LÀ 5 CHÌA KHÓA BẠN SẼ CÓ ĐƯỢC TRONG KHÓA HỌC NGHIỆP VỤ KẾ TOÁN TRONG DOANH NGHIỆP KINH DOANH DỊCH VỤ</div></div>
            ...
            <div class="container target">
                <div class="col-sm-6">
                    ...
                    <p class="con-t fontSFt">"
                        ...
                        <span data-sheets-value="{'1':2,'2':'- Kế toán năm cuối, mới ra trường\n- Kế toán chưa có kinh nghiệm, mất gốc\n- Nhân viên hành chính kiêm Kế toán trong doanh nghiệp KD dịch vụ\n- Thu ngân, Nhân viên bán hàng phải xuất hóa đơn cho khách'}" data-sheets-userformat="{'2':12604,'5':{'1':[{'1':2,'2':0,'5':[null,2,0]},{'1':0,'2':0,'3':3},{'1':1,'2':0,'4':1}]},'6':{'1':[{'1':2,'2':0,'5':[null,2,0]},{'1':0,'2':0,'3':3},{'1':1,'2':0,'4':1}]},'7':{'1':[{'1':2,'2':0,'5':[null,2,0]},{'1':0,'2':0,'3':3},{'1':1,'2':0,'4':1}]},'8':{'1':[{'1':2,'2':0,'5':[null,2,0]},{'1':0,'2':0,'3':3},{'1':1,'2':0,'4':1}]},'11':4,'15':'Arial','16':10}">Kế toán năm cuối, mới ra trường. Kế toán chưa có kinh nghiệm, mất gốc. Nhân viên hành chính kiêm Kế toán trong doanh nghiệp KD dịch vụ. Thu ngân, Nhân viên bán hàng phải xuất hóa đơn cho khách</span>"</p>
                </div>
                <div class="col-sm-6">
                    ...
                    <p class="con-t fontSFt"> Từ Kế toán chi tiết có thể xin tự tin tìm kiếm các vị trí kế toán tổng hợp
                        ...
                        Có Khă năng đọc hiểu báo cáo tài chính ở cấp độ cơ bản 
                        Kiểm tra được báo cáo tài chính do người khác làm đúng hay sai 
                        Có thể hướng dẫn, đào tạo được người chưa biết làm BCTC</p>
                </div>
            </div>
                    ...
                    <div class="col-sm-11 col-sm-offset-1">
                        <div class="part">
                            ...
                            <p class="pre-content">Khái niệm và mục đích của Báo cáo tài chính. <span class="hid-add">Yêu cầu của các đối tượng sử dụng báo cáo tài chính. 
                                    Các yếu tố chính trong báo cáo tài chính. Những quy định chung về báo cáo tài chính</span></p>
                            <p class="click-show">
                            ...
                            <div class="list-lesson">
                                <ul>
                                    ...
                                    <li>Bài 04: Những quy định chung về báo cáo tài chính</li> 
                                </ul>
                            </div>
                        </div>
                        <div class="part">
                        ...
                        <div class="part">
                            ...
                            <p class="title-part fontSFt">Những Vấn Đề Chung Về Hạch Toán Trong Doanh Nghiệp Dịch Vụ.</p>
                            ...
                            <div class="list-lesson">
                                <ul>
                                    <li>Bài 07:	Những vấn đề chung về hạch toán trong doanh nghiệp dịch vụ</li>
            ...
            <div class="dark">
                <img src="<?php echo base_url(); ?>public/kt320/img/shadow.png" alt="" class="img-responsive">
            </div>
            ...
            <div class="row" style="margin: 60px 0;">
                <div class="col-sm-6 col-md-3">
                    <div class="area text-center" style="font-size: 17px;">
                        <img src="<?php echo base_url(); ?>public/kt320/img/per3.png" alt="Vũ Thị Kim Nga">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="area text-center" style="font-size: 17px;">
                        <img src="<?php echo base_url(); ?>public/kt320/img/per2.png" alt="Vũ Thị Kim Nga">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="area text-center" style="font-size: 17px;">
                        <img src="<?php echo base_url(); ?>public/kt320/img/per4.png" alt="Vũ Thị Kim Nga">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="area text-center" style="font-size: 17px;">
                        <img src="<?php echo base_url(); ?>public/kt320/img/per1.png" alt="Vũ Thị Kim Nga">
        ...
        <div class="container-fluid lecture">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <img src="<?php echo base_url(); ?>public/kt320/img/lecture.jpg" alt="Phạm Thị Nhung" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid course-gui">
            <div class="container">
                ...
                <img src="<?php echo base_url(); ?>public/kt320/img/course-GUI.jpg" alt="Giao diện khóa học" class="img-responsive">
            </div>
        </div>
        ...
        <div class="container-fluid vnexpress">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <img class="vnexpress-logo" src="<?php echo base_url(); ?>public/kt320/img/vnexpress-logo.png" style="border-image-outset: 5px; " alt="Tạp chí vnexpress" class="img-responsive">
                    </div>
                    <div class="col-sm-8">
