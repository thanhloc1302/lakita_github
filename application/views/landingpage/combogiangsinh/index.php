            ...
            <div id="SECTION631" style="z-index: 9" class="widget-section ladi-drop" lp-type="widget_section" lp-widget="widget" lp-lang="SECTION" lp-display="block">
                <div class="container">
                    ...
                    <div id="GROUP796" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                        <div class="widget-content"><a id="BUTTON780" class="widget-element widget-snap style-1 ladi-drop" lp-type="button" lp-lang="BUTTON" lp-background="button" lp-group="GROUP796" lp-display="table"><span class="widget-content">Đăng kí ngay</span> </a>
                    ...
                    <div id="GROUP979" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                        <div class="widget-content">
                            ...
                            <div id="BOX645" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP979" lp-display="block">
                                <div class="widget-content">
                                    <div id="HEADLINE647" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-display="block">
                                        <h3 class="widget-content" lp-node="h3">Combo 2</h3> </div><a id="BUTTON646" class="widget-element widget-snap style-1 ladi-drop" lp-type="button" lp-lang="BUTTON" lp-background="button" lp-display="table" lp-action-link="POPUP697" lp-action-type="popup" lp-target="" href=""><span class="widget-content">Chi tiết</span> </a><a id="BUTTON781" class="widget-element widget-snap style-1 ladi-drop" lp-type="button" lp-lang="BUTTON" lp-background="button" lp-display="table"><span class="widget-content">Đăng kí ngay</span> </a></div>
                                <div class="ladi-widget-overlay"></div>
                            </div>
                            ...
                            <div id="GROUP797" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP" lp-display="block" lp-group="GROUP979">
                                <div class="widget-content"></div>
                            </div>
                        </div>
                    </div>
