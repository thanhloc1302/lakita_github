    ...
    <body>
        ...
        <div id="SECTION12" class="widget-section ladi-drop" lp-type="widget_section" lp-widget="widget" lp-lang="SECTION" lp-display="block">
            <div class="container">
                <div id="GROUP15" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                    <div class="widget-content">
                        ...
                        <div id="HEADLINE326" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-group="GROUP15" lp-display="block">
                            <h6 class="widget-content" lp-node="h6">7</h6> </div>
                ...
                <div id="GROUP20" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                    <div class="widget-content">
                        <div id="HEADLINE23" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-group="GROUP20" lp-display="block">
                            <h6 class="widget-content" lp-node="h6">tư thế</h6> </div>
                        <div id="PARAGRAPH24" class="widget-element widget-snap" lp-type="textparagraph" lp-editor="true" lp-lang="PARAGRAPH" lp-group="GROUP20" lp-display="block">
                        ...
                        <div id="BOX21" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP20" lp-display="block">
                            <div class="widget-content"></div>
                            <div class="ladi-widget-overlay"></div>
                        </div>
                        <div id="PARAGRAPH366" class="widget-element widget-snap" lp-type="textparagraph" lp-editor="true" lp-lang="PARAGRAPH" lp-group="GROUP20" lp-display="block">
            ...
            <div class="container">
                ...
                <div id="PARAGRAPH265" class="widget-element widget-snap" lp-type="textparagraph" lp-editor="true" lp-lang="PARAGRAPH" lp-display="block">
                    <p class="widget-content" lp-node="p">GIẢM GIÁ 50% cho 100 khách hàng đăng ký đầu tiên
                        ...
                        <br color="" style="color: rgb(255, 255, 255);">
                        <br color="" style="color: rgb(255, 255, 255);">MIỄN PHÍ chuyển phá trên toàn quốc</p>
                </div>
        ...
        <script type="text/javascript" async="" src="https://static.ladipage.net/source/ladipage.lib.1.js?v=1513050416464"></script>
        <div class="container">
            <div class="row">
