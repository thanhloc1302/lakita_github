                    ...
                    <div class="widget-content">
                        <div id="GROUP419" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                            <div class="widget-content">
                                ...
                                <div id="COUNTDOWN429" class="widget-element widget-snap" lp-type="countdown" lp-lang="COUNTDOWN" lp-endtime="78602" lp-endtimetype="timedown" lp-group="GROUP419" lp-display="block">
                                    <div class="widget-content">
