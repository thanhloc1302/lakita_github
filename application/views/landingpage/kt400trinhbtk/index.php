        ...
        <div class="ladi-wraper-page">
            <div id="SECTION212" class="widget-section ladi-drop" lp-type="widget_section" lp-widget="widget" lp-lang="SECTION" lp-display="block">
                <div class="container">
                    ...
                    <div id="PARAGRAPH214" class="widget-element widget-snap" lp-type="textparagraph" lp-editor="true" lp-lang="PARAGRAPH" lp-display="block">
                        <h6 class="widget-content" lp-node="h6">Hệ thống kiến thức rõ ràng<br>Áp dụng ngay vào công việc thực tiễn</h6> </div>
                    ...
                    <div id="HEADLINE224" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-display="block">
                        <h1 class="widget-content" lp-node="h1">82%</h1> </div><a id="BUTTON251" class="widget-element widget-snap style-1 ladi-drop wow swing animated" lp-type="button" lp-lang="BUTTON" lp-background="button" lp-display="table" lp-action-link="SECTION86" lp-action-type="page" lp-target="" href=""><span class="widget-content">TÌM HIỂU NGAY!</span> </a>
                    <div id="BOX252" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-display="block" lp-sticky="1" lp-sticky-pos="top" lp-sticky-kc="0px">
                        <div class="widget-content">
                            <div id="IMAGE253" class="widget-element widget-snap ladi-drop" lp-type="image" lp-lang="IMAGE" lp-display="block">
                                <div class="widget-content">
                                    <div class="lp-show-image" alt="https://static.ladipage.net/5a28c4f8c3f6592b3acabec8/logo-1512734330941.png"></div>
            ...
            <div id="SECTION86" class="widget-section ladi-drop" lp-type="widget_section" lp-widget="widget" lp-lang="SECTION" lp-display="block">
                <div class="container">
                    ...
                    <div id="IMAGE88" class="widget-element widget-snap ladi-drop" lp-type="image" lp-lang="IMAGE" lp-display="block">
                        <div class="widget-content">
                    ...
                    <div id="GROUP453" class="widget-element widget-snap widget-group wow bounceInLeft animated" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                        <div class="widget-content">
                            <div id="BOX91" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP453" lp-display="block">
                                <div class="widget-content">
                            ...
                            <div id="BOX260" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP453" lp-display="block">
                                <div class="widget-content">
                            ...
                            <div id="BOX249" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP453" lp-display="block">
                                <div class="widget-content">
                    ...
                    <div id="GROUP454" class="widget-element widget-snap widget-group wow bounceInRight animated" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                        <div class="widget-content">
                            <div id="BOX262" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP454" lp-display="block">
                                <div class="widget-content">
                            ...
                            <div id="BOX95" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP454" lp-display="block">
                                <div class="widget-content">
                            ...
                            <div id="BOX93" class="widget-element widget-snap ladi-drop" lp-type="box" lp-lang="BOX" lp-group="GROUP454" lp-display="block">
                                <div class="widget-content">
            ...
            <div id="SECTION300" class="widget-section ladi-drop animated" lp-type="widget_section" lp-widget="widget" lp-lang="SECTION" lp-display="block" lp-ani="wow flash animated">
                <div class="container">
                    <div id="IMAGE314" class="widget-element widget-snap ladi-drop" lp-type="image" lp-lang="IMAGE" lp-display="block">
                        <div class="widget-content">
                            <div class="lp-show-image" alt="https://static.ladipage.net/5a28c4f8c3f6592b3acabec8/21761373_1704766096260447_1445339622421389708_n-1513007569.jpg"></div>
                            <div class="lp-show-image"></div>
                        </div>
                        <div class="ladi-widget-overlay"></div>
                    </div>
            ...
            <div id="SECTION98" class="widget-section ladi-drop" lp-type="widget_section" lp-widget="widget" lp-lang="SECTION" lp-display="block">
                <div class="container">
                    ...
                    <div id="YOUTUBE318" class="widget-element widget-snap" lp-type="videoyoutube" lp-lang="YOUTUBE" lp-autoplay="0" lp-display="block">
                    ...
                    </div><a id="BUTTON320" class="widget-element widget-snap style-1 ladi-drop" lp-type="button" lp-lang="BUTTON" lp-background="button" lp-display="table" lp-action-link="SECTION416" lp-action-type="page" lp-target="" href=""><span class="widget-content">ĐĂNG KÝ NGAY!</span> </a></div>
                <div class="ladi-widget-overlay"></div>
            </div>
                    ...
                    <div id="IMAGE357" class="widget-element widget-snap ladi-drop" lp-type="image" lp-lang="IMAGE" lp-display="block">
                        <div class="widget-content">
                            ...
                            <div id="HEADLINE358" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-display="block">
                                <h6 class="widget-content" lp-node="h6">CẦM TAY CHỈ VIỆC</h6> </div>
                        </div>
                        <div class="ladi-widget-overlay"></div>
                    </div>
                        ...
                        <div class="widget-content">
                            ...
                            <div id="GROUP430" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP" lp-display="block">
                                <div class="widget-content">
                                    ...
                                    </div><a id="BUTTON431" class="widget-element widget-snap style-1 ladi-drop" lp-type="button" lp-lang="BUTTON" lp-background="button" lp-parent="FORM432" lp-group="GROUP430" lp-display="table"><span class="widget-content">GỬI LIÊN HỆ TỚI CHÚNG TÔI</span> </a></div>
                            </div>
                            <div id="HEADLINE418" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-display="block">
                                <h4 class="widget-content" lp-node="h4">NHANH LÊN!<br color="" style="color: rgb(244, 67, 54);">THỜI GIAN NHẬN ƯU ĐÃI CHỈ CÒN</h4> </div>
                        </div>
                        <div class="ladi-widget-overlay"></div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div id="HEADLINE452" class="widget-element widget-snap" lp-type="textinline" lp-editor="true" lp-lang="HEADLINE" lp-display="block">
                        <p class="widget-content" lp-node="p">Địa chỉ: Tầng 7, tòa CT1 Skylight, 125D Minh Khai, HBT, Hà Nội
                            <br>Điện thoại: 1900 636 195 - 024 7306 2468</p>
                    </div>
                </div>
                <div class="ladi-widget-overlay"></div>
            </div>
            <script type="text/javascript" async="" src="https://static.ladipage.net/source/ladipage.lib.1.js?v=1513650846576"></script>
            <script>
                var loadCSSFiles = function () {
                    var links = 'https://static.ladipage.net/source/animate.min.css?v=1513650846576';
