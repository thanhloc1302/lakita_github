...
<html lang="en">
    <head>
        ...
        <title>Khóa Thuế Thu Nhập Cá Nhân (PIT) Cơ Bản Tới Nâng Cao</title>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
        <script src="<?php echo base_url(); ?>public/kt360/js/responsive.js" type="text/javascript"></script>
        <script src="https://use.fontawesome.com/d826c84253.js"></script>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/kt360/css/bootstrap-theme.css">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/kt360/css/style.css">
    ...
    <body>
        ...
        <div class="container-fluid header">
            <nav class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><img id="logo" class="img-responsive col-sm-offset-1" src="<?php echo base_url(); ?>public/kt360/img/top-logo.png" alt="Lakita.vn"></a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <img class="img-responsive col-sm-offset-1 img-hide" src="<?php echo base_url(); ?>public/kt360/img/top-add.png" alt="">
                    ...
                    <div class="col-sm-6 col-md-5 col-md-offset-1">
                        <img class="img-responsive" src="<?php echo base_url(); ?>public/kt360/img/TYPO-08.png" alt="16 giờ học">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-7 saleoff">
                                <p><span><img src="<?php echo base_url(); ?>public/kt360/img/gift.png" alt=""></span> Khuyến mại giảm giá khóa học đến 400.000đ</p>
                            </div>
                        </div>
        ...
        <div class="container welcome fontSF">
            <div class="row wellcome-text">
                Chào mừng bạn đến với trang thông tin của khóa học Thuế Thu Nhập Cá Nhân (PIT) Cơ Bản Tới Nâng Cao. Trước khi tìm hiểu chi tiết, Lakita xin tặng bạn<br>
                BỘ QUÀ TẶNG trị giá 5 trăm ngàn đồng sau:
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <img src="<?php echo base_url(); ?>public/kt360/img/18excel.jpg" alt="" class="img-responsive shadow">
                </div>
                <div class="col-sm-8">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 text-center feature">
                        <img src="<?php echo base_url(); ?>public/kt360/img/online.png" alt="Học online">
                        <p>HỌC ONLINE</p>
                        <p>Mô hình học online tiên tiến, mọi lúc, mọi nơi, mọi thiết bị</p>
                    </div>
                    <div class="col-sm-6 col-md-3 text-center feature">
                        <img src="<?php echo base_url(); ?>public/kt360/img/quality.png" alt="Cam kết chất lượng">
                        <p>CAM KẾT CHẤT LƯỢNG</p>
                        <p>Hoàn lại 100% tiền nếu bạn không hài lòng về khóa học</p>
                    </div>
                    <div class="col-sm-6 col-md-3 text-center feature">
                        <img src="<?php echo base_url(); ?>public/kt360/img/exchange.png" alt="Giải pháp nhanh chóng">
                        <p>GIẢI PHÁP NHANH CHÓNG</p>
                        <p>Đội ngũ trợ giảng giải đáp thắc mắc qua hệ thống forum tiện dụng</p>
                    </div>
                    <div class="col-sm-6 col-md-3 text-center feature">
                        <img src="<?php echo base_url(); ?>public/kt360/img/time.png" alt="Sở hữu trọn đời">
                        <p>SỞ HỮU TRỌN ĐỜI</p>
        ...
        <div class="container lineout">
            <div class="row">
                <div class="col-xs-12 text-center SFDisplay" style="font-size: 25px; color: #2e3d49;">DƯỚI ĐÂY LÀ 4 CHÌA KHÓA BẠN SẼ CÓ ĐƯỢC TRONG KHÓA HỌC <br>
                    THUẾ THU NHẬP CÁ NHÂN  (PIT) CƠ BẢN ĐẾN NÂNG CAO</div></div>
            ...
            <div class="container target">
                <div class="col-sm-6">
                    ...
                    <p class="con-t fontSFt">"
                        ...
                        <span data-sheets-value="{'1':2,'2':'- Tất cả các cá nhân có thu nhập phải kê khai thuế TNCN.\n'- Sinh viên khối ngành kinh tế, kế toán sắp ra trường\n- Nhân viên hành chính kiêm Kế toán trong doanh nghiệp.\n- Kế toán viên, kế toán tổng hợp, kế toán trưởng.\n- Các cá nhân, tổ chức mong muốn tối ưu thuế TNCN phải nộp, có kế hoạch tốt về thuế TNCN cho doanh nghiệp'}" data-sheets-userformat="{'2':12604,'5':{'1':[{'1':2,'2':0,'5':[null,2,0]},{'1':0,'2':0,'3':3},{'1':1,'2':0,'4':1}]},'6':{'1':[{'1':2,'2':0,'5':[null,2,0]},{'1':0,'2':0,'3':3},{'1':1,'2':0,'4':1}]},'7':{'1':[{'1':2,'2':0,'5':[null,2,0]},{'1':0,'2':0,'3':3},{'1':1,'2':0,'4':1}]},'8':{'1':[{'1':2,'2':0,'5':[null,2,0]},{'1':0,'2':0,'3':3},{'1':1,'2':0,'4':1}]},'11':4,'15':'Arial','16':10}">Tất cả các cá nhân có thu nhập phải kê khai thuế TNCN. Sinh viên khối ngành kinh tế, kế toán sắp ra trường. Nhân viên hành chính kiêm Kế toán trong doanh nghiệp. Kế toán viên, kế toán tổng hợp, kế toán trưởng. Các cá nhân, tổ chức mong muốn tối ưu thuế TNCN phải nộp, có kế hoạch tốt về thuế TNCN cho doanh nghiệp</span>"</p>
                </div>
                <div class="col-sm-6">
                    <p class="tit-t fontSFt">HÌNH MẪU HỌC VIÊN SẼ ĐẠT ĐƯỢC SAU KHÓA HỌC</p>
                    <p class="con-t fontSFt"> Cá nhân và doanh nghiệp tránh được các khoản phạt không đáng có từ việc thiếu kiến thức về thuế TNCN
                        Cá nhân và doanh nghiệp vận dụng kiến thức về thuế ở đây để đóng thuế dưới sự tuân thủ về luật với mức thấp nhất có thể.
                        Nắm vững luật thuế TNCN có thể tiết kiệm được khoản tiền khổng lồ nhờ vào việc hiểu biết kiến thức về thuế. Bằng việc học viên có thể tối ưu số thuế TNCN phải nộp, lập được kế hoạch thuế cho doanh nghiệp của mình, mang lại giá trị to lớn cho doanh nghiệp</p>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-11 col-sm-offset-1">
                        <div class="part">
                            ...
                            <p class="title-part fontSFt">Tổng Quan Về Thuế Thu Nhập Cá Nhân</p>
                            <p class="pre-content">Thuế TNCN là gì. <span class="hid-add">Sự cần thiết của thuế TNCN. Chức năng và vai trò của thuế TNCN. Các quy định pháp luật liên quan tới việc thuế TNCN. Xác định đối tượng nộp thuế. Các khoản thu nhập chịu thuế TNCN. Các khoản thu nhập miễn thuế TNCN. Giảm thuế. Kỳ tính thuế TNCN </span></p>
                            <p class="click-show">
                            ...
                            <div class="list-lesson">
                                <ul>
                                    <li>Bài 01: Thuế TNCN là gì </li>
                                    <li>Bài 02: Sự cần thiết của thuế TNCN</li> 
                                    <li>Bài 03: Chức năng và vai trò của thuế TNCN </li>
                                    <li>Bài 04: Các quy định pháp luật liên quan tới việc thuế TNCN</li> 
                                    <li>Bài 05: Xác định đối tượng nộp thuế</li> 
                                    <li>Bài 06: Các khoản thu nhập chịu thuế TNCN</li> 
                                    <li>Bài 07: Các khoản thu nhập miễn thuế TNCN</li> 
                                    <li>Bài 08: Giảm thuế</li> 
                                    <li>Bài 09: Kỳ tính thuế TNCN</li> 
                                </ul>
                            </div>
                        </div>
                        <div class="part">
                            <p class="name fontSFt"><i class="fa fa-circle" aria-hidden="true"></i><span>CHƯƠNG 2</span></p>
                            <p class="title-part fontSFt">Thuế TNCN Đối Với Cá Nhân Cư Trú Có Thu Nhập Từ Tiền Lương, Tiền Công.</p>
                            <p class="pre-content">Đối tượng nộp thuế TNCN. <span class="hid-add">Thu nhập chịu thuế TNCN. Thu nhập miễn thuế TNCN. Căn cứ tính thuế TNCN. Thuế suất thuế TNCN. Khấu trừ thuế TNCN. Khai thuế TNCN</span></p>
                            <p class="click-show">
                                <span class="vie">Xem chi tiết<i class="fa fa-angle-double-down" aria-hidden="true"></i></span>
                                <span class="hid">Rút gọn<i class="fa fa-angle-double-up" aria-hidden="true"></i></span>
                            </p>
                            <div class="list-lesson">
                                <ul>
                                    <li>Bài 10: Đối tượng nộp thuế TNCN</li> 
                                    <li>Bài 11: Thu nhập chịu thuế TNCN</li>
                                    <li>Bài 12: Thu nhập miễn thuế TNCN</li>
                                    <li>Bài 13: Căn cứ tính thuế TNCN</li>
                                    <li>Bài 14: Thuế suất thuế TNCN</li>
                                    <li>Bài 15: Khấu trừ thuế TNCN</li>
                                    <li>Bài 16: Khai thuế TNCN</li>
                                </ul>
                            </div>
                        </div>
                        <div class="part">
                            <p class="name fontSFt"><i class="fa fa-circle" aria-hidden="true"></i><span>CHƯƠNG 3</span></p>
                            <p class="title-part fontSFt">Thuế TNCN Đối Với Cá Nhân Cư Trú Có Thu Nhập Chịu Thuế Khác.</p>
                            <p class="pre-content">Thuế TNCN đối với thu nhập từ đầu tư vốn. <span class="hid-add">Thuế TNCN đối với thu nhập từ chuyển nhượng vốn. Thuế TNCN đối với thu nhập từ chuyển nhượng bất động sản. Thuế TNCN đối với thu nhập từ trúng thưởng. Thuế TNCN đối với thu nhập từ bản quyền. Thuế TNCN đối với thu nhập từ nhượng quyền thương mại. Thuế TNCN đối với thu nhập từ nhận thừa kế, quà tặng. </span></p>
                            <p class="click-show">
                                <span class="vie">Xem chi tiết<i class="fa fa-angle-double-down" aria-hidden="true"></i></span>
                                <span class="hid">Rút gọn<i class="fa fa-angle-double-up" aria-hidden="true"></i></span>
                            </p>
                            <div class="list-lesson">
                                <ul>
                                    <li>Bài 17:	Thuế TNCN đối với thu nhập từ đầu tư vốn</li>
                                    <li>Bài 18:	Thuế TNCN đối với thu nhập từ chuyển nhượng vốn</li>
                                    <li>Bài 19:	Thuế TNCN đối với thu nhập từ chuyển nhượng bất động sản</li>
                                    <li>Bài 20:	Thuế TNCN đối với thu nhập từ trúng thưởng</li>
                                    <li>Bài 21:	Thuế TNCN đối với thu nhập từ bản quyền</li>
                                    <li>Bài 22:	Thuế TNCN đối với thu nhập từ nhượng quyền thương mại</li>
                                    <li>Bài 23:	Thuế TNCN đối với thu nhập từ nhận thừa kế, quà tặng</li>
                                </ul>
                            </div>
                        </div>
                        <div class="part">
                            <p class="name fontSFt"><i class="fa fa-circle" aria-hidden="true"></i><span>CHƯƠNG 4</span></p>
                            <p class="title-part fontSFt">Thuế TNCN Đối Với Cá Nhân Không Cư Trú</p>
                            <p class="pre-content">Các loại thu nhập chịu thuế TNCN của cá nhân không cư trú. <span class="hid-add">Căn cứ tính thuế TNCN. Đăng ký thuế TNCN. Khấu trừ thuế TNCN. Khai thuế TNCN.</span></p>
                            <p class="click-show">
                                <span class="vie">Xem chi tiết<i class="fa fa-angle-double-down" aria-hidden="true"></i></span>
                                <span class="hid">Rút gọn<i class="fa fa-angle-double-up" aria-hidden="true"></i></span>
                            </p>
                            <div class="list-lesson">
                                <ul>
                                    <li>Bài 24: Các loại thu nhập chịu thuế TNCN của cá nhân không cư trú</li>
                                    <li>Bài 25: Căn cứ tính thuế TNCN</li>
                                    <li>Bài 26: Đăng ký thuế TNCN</li>
                                    <li>Bài 27: Khấu trừ thuế TNCN</li>
                                    <li>Bài 25: Khai thuế TNCN</li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="dark">
                <img src="<?php echo base_url(); ?>public/kt360/img/shadow.png" alt="" class="img-responsive">
            </div>

        </div>

        <div class="container testimonial">
            <h1 class="fontSFt text-center" style="font-weight: bold; font-size: 30px; color: #ff0000;">LẮNG NGHE HỌC VIÊN NÓI VỀ KHÓA HỌC THUẾ THU NHẬP CÁ NHÂN (PIT) CƠ BẢN TỚI NÂNG CAO</h1>
            <div class="row" style="margin: 60px 0;">
                <div class="col-sm-6 col-md-3">
                    <div class="area text-center" style="font-size: 17px;">
                        <img src="<?php echo base_url(); ?>public/kt360/img/per3.png" alt="Vũ Thị Kim Nga">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="area text-center" style="font-size: 17px;">
                        <img src="<?php echo base_url(); ?>public/kt360/img/per2.png" alt="Vũ Thị Kim Nga">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="area text-center" style="font-size: 17px;">
                        <img src="<?php echo base_url(); ?>public/kt360/img/per4.png" alt="Vũ Thị Kim Nga">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="area text-center" style="font-size: 17px;">
                        <img src="<?php echo base_url(); ?>public/kt360/img/per1.png" alt="Vũ Thị Kim Nga">
        ...
        <div class="container-fluid lecture">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <img src="<?php echo base_url(); ?>public/kt360/img/lecture.jpg" alt="Phạm Thị Nhung" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid course-gui">
            <div class="container">
                ...
                <img src="<?php echo base_url(); ?>public/kt360/img/course-GUI.jpg" alt="Giao diện khóa học" class="img-responsive">
            </div>
        </div>
        ...
        <div class="container-fluid vnexpress">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <img class="vnexpress-logo" src="<?php echo base_url(); ?>public/kt360/img/vnexpress-logo.png" style="border-image-outset: 5px; " alt="Tạp chí vnexpress" class="img-responsive">
                    </div>
                    <div class="col-sm-8">
