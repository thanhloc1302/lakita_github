    ...
    <div class="header">
        ...
        <div class="row">
            <div class="col-md-6  my-row-1">
                <h1> <strong> THÊM MỚI 01 CHƯƠNG CỦA KHÓA HỌC BÍ QUYẾT LÀM CHỦ EXCEL 2010 </strong></h1>
            </div>
...
<div class="container text-justify" style="font-family: Roboto; font-size: 16px">
    <div class="row">
        <div class="col-md-6 col-md-push-3">
            ...
            <p> Lakita trân trọng thông báo đến bạn, 
                khóa học <strong> Bí quyết làm chủ Excel 2010 </strong> được nâng cấp thành khóa 
                <strong> Bí quyết làm chủ Excel năm 2017 </strong>
                đã được thêm 01 chương học về <strong> “PivotTable trong Excel”. </strong>  
            </p>
            <p> Vào học ngay tại: <a href="https://lakita.vn/gioi-thieu-ve-pivottable-4776.html"> https://lakita.vn/gioi-thieu-ve-pivottable-4776.html </a> </p>
    ...
    <div class="row">
        <div class="col-md-6 col-md-push-3">
            <div id="fb-root"></div> 
            <div  class="fb-comments" data-href="https://lakita.vn/tri-an-hoc-vien-002.html" data-width="100%" data-numposts="7" data-order-by="reverse_time"></div>
        </div>
    </div>
</div>
</div>
