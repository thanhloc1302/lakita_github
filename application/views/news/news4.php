    ...
    <div class="header">
        ...
        <div class="row">
            <div class="col-md-6  my-row-1">
                <h1> <strong> THÊM MỚI 01 CHƯƠNG CỦA KHÓA HỌC EXCEL DÀNH CHO KẾ TOÁN TỪ CƠ BẢN ĐẾN CHUYÊN SÂU </strong></h1>
            </div>
...
<div class="container text-justify" style="font-family: Roboto; font-size: 16px">
    <div class="row">
        <div class="col-md-6 col-md-push-3">
            ...
            <p>Hệ thống đào tào trực tuyến Lakita.vn trân trọng thông báo đến bạn, khóa học <strong>Excel dành cho kế toán từ cơ bản đến chuyên sâu</strong> sắp được cập nhật thêm 01 chương học về <strong>"PivotTable trong Excel"</strong>. Thời gian cập nhật dự kiến 31/05/2017.
            </p>
    ...
    <div class="row">
        <div class="col-md-6 col-md-push-3">
            <div id="fb-root"></div> 
            <div  class="fb-comments" data-href="https://lakita.vn/tri-an-hoc-vien-004.html" data-width="100%" data-numposts="7" data-order-by="reverse_time"></div>
        </div>
    </div>
</div>
</div>
