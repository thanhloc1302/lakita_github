            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingOne">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#cod_method_content" aria-expanded="false" aria-controls="cod_method_content">
                                <p class="methods_choose" value='cod_method_content'><i class="fa fa-circle-o" aria-hidden="true"></i> &nbsp;&nbsp; Giao khóa học và thu tiền tận nơi</p>
                            </a>
                        </h4>
                    </div>
                    <div id="cod_method_content" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <div class="col-xs-12">
                                ...
                                <div class="input-group marginbottom10 hidden">
                                    <span class="input-group-addon"><i class="fa fa-map-marker fa-fw" aria-hidden="true"></i></span>
                                    <input type="text" class="form-control" name="cod_tinh" placeholder="Nhập Tỉnh/Thành Phố" value="VN" aria-describedby="basic-addon1">
                                </div>

                                <div class="input-group marginbottom10 hidden">
                                    <span class="input-group-addon"><i class="fa fa-map-marker fa-fw" aria-hidden="true"></i></span>
                                    <input type="text" class="form-control" name="cod_quan" id="login_email" placeholder="Nhập Quận/Huyện" value="VN" aria-describedby="basic-addon1">
                                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingTwo">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#direct_method_content" aria-expanded="false" aria-controls="direct_method_content">
                                <p class="methods_choose" value='direct_method_content'><i class="fa fa-circle-o" aria-hidden="true"></i> &nbsp;&nbsp; Thanh toán trực tiếp tại VP Lakita</p>
                            </a>
                        </h4>
                    </div>
                    <div id="direct_method_content" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <div class="col-xs-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingThree">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#transfer_method_content" aria-expanded="false" aria-controls="transfer_method_content">
                                <p class="methods_choose" value='transfer_method_content'><i class="fa fa-circle-o" aria-hidden="true"></i> &nbsp;&nbsp; Chuyển khoản qua ngân hàng</p>
                            </a>
                        </h4>
                    </div>
                    <div id="transfer_method_content" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body">
                            <div class="col-xs-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingFour">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#mobile_method_content" aria-expanded="false" aria-controls="mobile_method_content">
                                <p class="methods_choose" value='mobile_method_content'><i class="fa fa-circle-o" aria-hidden="true"></i> &nbsp;&nbsp; Thanh toán bằng thẻ cào điện thoại</p>
                            </a>
                        </h4>
                    </div>
                    <div id="mobile_method_content" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                        <div class="panel-body">
                            <div class="col-xs-12">
                                <?php
                                ...
                                if (!isset($user_id)) {
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            <a href="<?php echo base_url() . 'dang-nhap.html'; ?>" class="btn btn-success btn-lg btn-block menu_login_mobile" redirect_type="mobile"> ĐĂNG NHẬP </a>
                                        </div>
                                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingFive">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#atm_method_content" aria-expanded="false" aria-controls="atm_method_content">
                                <p class="methods_choose" value='atm_method_content'><i class="fa fa-circle-o" aria-hidden="true"></i> &nbsp;&nbsp; Thanh toán trực tuyến bằng thẻ ATM</p>
                            </a>
                        </h4>
                    </div>
                    <div id="atm_method_content" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                        <div class="panel-body">
                            <div class="col-xs-12">
                                <?php if (!isset($user_id)) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            <a href="<?php echo base_url() . 'dang-nhap.html'; ?>" class="btn btn-success btn-lg btn-block menu_login_mobile" redirect_type="atm"> ĐĂNG NHẬP </a>
                                        </div>
                                    </div>
                                    <?php
                                } else {
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingSix">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#visa_method_content" aria-expanded="false" aria-controls="visa_method_content">
                                <p class="methods_choose" value='visa_method_content'><i class="fa fa-circle-o" aria-hidden="true"></i> &nbsp;&nbsp; Thanh toán bằng thẻ VISA/MasterCard</p>
                            </a>
                        </h4>
                    </div>
                    <div id="visa_method_content" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                        <div class="panel-body">
                            <div class="col-xs-12">
                                <?php if (!isset($user_id)) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            <a href="<?php echo base_url() . 'dang-nhap.html'; ?>" class="btn btn-success btn-lg btn-block menu_login_mobile" redirect_type="visa"> ĐĂNG NHẬP </a>
                                        </div>
                                    </div>
                                    <?php
                                } else {
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingSeven">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#lakita_method_content" aria-expanded="false" aria-controls="lakita_method_content">
                                <p class="methods_choose" value='lakita_method_content'><i class="fa fa-circle-o" aria-hidden="true"></i> &nbsp;&nbsp; Thanh toán bằng số dư LAKITA</p>
                            </a>
                        </h4>
                    </div>
                    <div id="lakita_method_content" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                        <div class="panel-body">
                            <div class="col-xs-12">
                                <?php if (!isset($user_id)) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            <a href="<?php echo base_url() . 'dang-nhap.html'; ?>" class="btn btn-success btn-lg btn-block menu_login_mobile" redirect_type="lakita"> ĐĂNG NHẬP </a>
                                        </div>
                                    </div>
                                    <?php
                                } else {
...
<script>
    $(document).ready(function () {
        ...
        $(".methods_choose").click(function () {
            if (collapse != $(this).attr('value')) {
                $(".methods_choose").removeClass('methods_choose_active');
                $(this).addClass('methods_choose_active');
                collapse = $(this).attr('value');
            } else {
                $(this).removeClass('methods_choose_active');
                collapse = '';
            }
        });
    });
